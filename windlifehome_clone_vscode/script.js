const translations = {
  es: {
    ...
    pricing: {
      ...
      homeSub: "9 camas · Habitación 1 y Habitación 2 · R$ 150 por persona/noche",
      roomA: "Habitación 1",
      roomB: "Habitación 2",
    ...
    location: {
      ...
      transferValue: "Shuttle desde Fortaleza · R$ 600",
...
function getBookingOptions(mode = getBookingMode()) {
  ...
  return [
    {
      name: getNestedTranslation(dict, "booking.roomA") || "Habitación 1",
      description: getNestedTranslation(dict, "pricing.roomDetail") || getNestedTranslation(dict, "booking.roomDesc"),
      price: `R$ 150 ${getNestedTranslation(dict, "booking.perNight") || "por persona/noche"}`
    },
    {
      name: getNestedTranslation(dict, "booking.roomB") || "Habitación 2",
      description: getNestedTranslation(dict, "pricing.roomDetail") || getNestedTranslation(dict, "booking.roomDesc"),
      price: `R$ 150 ${getNestedTranslation(dict, "booking.perNight") || "por persona/noche"}`
    }
  ];
