...
function getBookingOptions(mode = getBookingMode()) {
  ...
  return [
    {
      name: getNestedTranslation(dict, "booking.roomA") || "Habitación para 2 personas",
      description: getNestedTranslation(dict, "pricing.roomDetail") || getNestedTranslation(dict, "booking.roomDesc"),
      price: `R$ 150 ${getNestedTranslation(dict, "booking.perNight") || "por noche"}`
    },
    {
      name: getNestedTranslation(dict, "booking.roomB") || "Habitación para 3 personas",
      description: getNestedTranslation(dict, "pricing.roomDetail") || getNestedTranslation(dict, "booking.roomDesc"),
      price: `R$ 150 ${getNestedTranslation(dict, "booking.perNight") || "por noche"}`
    }
  ];
